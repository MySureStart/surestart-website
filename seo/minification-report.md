...
| Metric | Value |
|--------|-------|
| Files Copied to /dist | 2921 |
| CSS Files Minified | 8 |
| JS Files Minified | 3 |
| HTML Files Updated | 14 |
| Original Total Size | 750.3 KB |
| Minified Total Size | 480.2 KB |
| **Total Savings** | **270.1 KB (36.0%)** |
...
| `k12.css` | 149.9 KB | 106.2 KB | 43.6 KB (29.1%) |
| `students.css` | 67.6 KB | 48.3 KB | 19.3 KB (28.5%) |
| `styles.css` | 132.5 KB | 89.7 KB | 42.8 KB (32.3%) |
...
| Original File | Size | Minified | Savings |
|---------------|------|----------|---------|
| `impact-stories.js` | 99.5 KB | 49.6 KB | 49.9 KB (50.1%) |
| `k12-scroll.js` | 12.2 KB | 6.5 KB | 5.7 KB (46.7%) |
| `script.js` | 74.5 KB | 28.9 KB | 45.6 KB (61.2%) |
